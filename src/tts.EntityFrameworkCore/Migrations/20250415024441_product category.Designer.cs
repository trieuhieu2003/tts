...
namespace tts.Migrations
{
    ...
    [Migration("20250415024441_product category")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("tts.Categories.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("tts.Products.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("tts.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("tts.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("tts.Products.Product", b =>
                {
                    b.HasOne("tts.Categories.Category", "Category")
                        .WithMany()
