...
{
    public abstract class ttsWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ttsWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ttsWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ttsDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ttsDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ttsDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ttsDbContext, Task<T>> func)
        {
            T result;
